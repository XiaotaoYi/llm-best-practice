...
print(f"训练集: {len(final_dataset['train'])} 样本")
print(f"测试集: {len(final_dataset['test'])} 样本")
...
# 保存整个DatasetDict（推荐）
save_path = "./medical_dialogue_dataset"
final_dataset.save_to_disk(save_path)

# 也可以分开保存（可选）
#final_dataset["train"].save_to_disk("./train_dataset")
#final_dataset["test"].save_to_disk("./test_dataset")
